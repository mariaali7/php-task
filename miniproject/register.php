...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $sql = "INSERT INTO logininfo (email, mobile, first_name, middle_name, last_name, family_name, password, dob) VALUES ('$email', '$mobile', '$firstName', '$middleName', '$lastName', '$familyName', '$password', '$year-$month-$day')";
