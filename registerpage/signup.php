...
<body>
  ...
  <form action="register.php" method="POST">
    ...
    <small>Minimum 8 characters, at least one uppercase letter, one lowercase letter, one number, and one special character (@$!%*?&#)</small><br><br>
